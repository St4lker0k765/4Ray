...
public:
	...
	uSpatialDB*	space;
public:
	walker					(uSpatialDB*	_space, u32 _mask, const Fvector& _start, const Fvector&	_dir, float _range)
	{
		mask			= _mask;
		ray.pos.set		(_start);
...
void	uSpatialDB::q_ray	(xr_vector<ISpatial*>& R, u32 _o, u32 _mask_and, const Fvector&	_start,  const Fvector&	_dir, float _range)
{
	cs.Enter						();
	q_result						= &R;
