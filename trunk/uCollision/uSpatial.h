...
public:
	struct	_spatial
	{
		...
		uSpatialDB*			space;			// allow different spaces
...
ENGINE_API extern uSpatialDB*		g_SpatialSpace			;
ENGINE_API extern uSpatialDB*		g_SpatialSpacePhysic	;
